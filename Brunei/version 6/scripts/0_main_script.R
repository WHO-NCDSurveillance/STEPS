...
country = 'Brunei Darussalam'      # Country for the survey
survey_year = 2023       # Year of the survey
...
row_strat_variable_titles =c("Age Categories (Years)",'Area')  # Titles for row stratifiers
...
country_ISO = 'BRN'  # ISO code for the country
