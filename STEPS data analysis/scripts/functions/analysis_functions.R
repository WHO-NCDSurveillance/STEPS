...
flextab_function = function(index =1, table_label ='Men')
{
  ...
  for(lt in colnosplit)
  {
    ...
    #if(sub_formatrix$section=='Demographic'){source('scripts/functions/table_formatting_function_demog.R')}else{source('scripts/functions/table_formatting_function_nondemog.R')}
