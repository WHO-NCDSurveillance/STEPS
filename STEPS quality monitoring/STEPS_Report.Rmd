...
# # or
# onausername <- "username"
# onapassword <- "password"

step1_form_id <- "123456"	#numeric STEP1-2 form ID from form url
step3_form_id <- "123456"	#numeric STEP3 form ID from form url
sample_size <- 5000		#survey sample size
hh_per_cluster <- xx	#number of households selected per cluster
...
# Group by 'i1' and 'i2b' and summarize
by_cluster <- group_by(data1, i1, i2b)
