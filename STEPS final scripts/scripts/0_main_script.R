...
list_packages = c('openxlsx','readxl','tidyverse','survey','stringr',
                  'officer','flextable','readstata13','dplyr','haven','polyglotr','magrittr') #,'officerWinTools'
...
country = 'Lebanon'      # Country for the survey
...
country_ISO = 'LBN'  # ISO code for the country
